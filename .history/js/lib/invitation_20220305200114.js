...
export default class FormHandler {
  ...
  constructor() {
    ...
    this.anim = lottie.loadAnimation({
      container: document.querySelector('.successGG'),
      renderer: 'svg',
      autoplay: false,
      loop: false,
  ...
  clickHandler = () => {
    console.log(lottie, this.anim, bodymovin)
    document.querySelectorAll('input').forEach(node => node.classList.add('fadeOut'))
